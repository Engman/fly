...
ParticleCollisionSystem::ParticleCollisionSystem(const ParticleCollisionSystem& other)
{
}
...
bool ParticleCollisionSystem::Initialize()
{
	...
	materialDesc.name = L"collision_particle";
	...
	desc.material_id = MaterialHandler::GetMaterial(L"collision_particle")->GetID();
...
void ParticleCollisionSystem::Shutdown()
{
...
void ParticleCollisionSystem::Render(ViewFrustum f)
{
...
void ParticleCollisionSystem::EmitParticles(float frameTime, vec3 forward)
{
	bool emitParticle;
...
void ParticleCollisionSystem::UpdateParticles(float frameTime)
{
	int i;
...
void ParticleCollisionSystem::KillParticles(vec3 position)
{
	int i;
...
void ParticleCollisionSystem::SetRotation(vec3 rotation)
{
	for(int i = 0; i < this->currentParticleCount; i++)
	{
...
void ParticleCollisionSystem::SetPosition(vec3 position)
{
...
void ParticleCollisionSystem::SetParticleShader(IShader* shader)
{
	for(int i = 0; i < this->currentParticleCount; i++)
	{
