...
#include "GBufferWaterShader.h"

GBufferWaterShader::GBufferWaterShader()
{
...
void GBufferWaterShader::draw(PER_FRAME_DATA& frameData)
{	
	int indexC = 0;
	int vertexC = 0;
	...
	for( int i = 0; i< count;i++)
	{
		...
		frameData.waterBuffer->setBuffer(1);
