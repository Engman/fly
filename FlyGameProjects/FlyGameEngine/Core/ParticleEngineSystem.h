#ifndef PARTICLEENGINESYSTEM_H
#define PARTICLEENGINESYSTEM_H
...
class ParticleEngineSystem
{
	...
	public:
		...
		ParticleEngineSystem(const ParticleEngineSystem&);
		virtual ~ParticleEngineSystem();
