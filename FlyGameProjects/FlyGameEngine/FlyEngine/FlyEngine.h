...
class FlyEngine
{
	public:
		...
		*	New Reference */
		...
		/** Converts a screen spacce coordinate to 3 dimensional world space vector/position */
		virtual void		FLYCALL		FromScreenSpaceToWorldSpace	(int x, int y, float& wx, float& wy, float& wz)						= 0;
