...
bool FlyState_Level::_ImportPlayer(wifstream& file, vector<IShader*>& shaders)
{
	...
	this->player.GetModel()->at(0)->setPosition(vec3(0.0f, 30.0f, 0.0f));
	this->player.GetModel()->at(0)->setRotation(vec3(0.0f, 0.0f, 0.0f));
	this->player.GetModel()->at(0)->setScale(vec3(1.0f, 1.0f, 1.0f));
