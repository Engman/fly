...
class Input
{
	...
	public:
		...
		/* Registers a new input device, using simplified parameter (Recomended) */
		bool registerInputDevice											(const GLARE_INPUT_INIT_DESC&);
		/* Registers a new input device, using specific [RAWINPUTDEVICE] description */
		bool registerInputDevice											(const RAWINPUTDEVICE&, HWND);
